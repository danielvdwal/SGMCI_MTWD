...
public class DreamerScene extends AbstractMTWDScene {
    ...
    public void createEventListeners() {
        ...
        user1Workspace.getCloseButton().addGestureListener(TapAndHoldProcessor.class, new CloseButtonListener(AbstractMTWDSceneController.USER1_ID));
        ...
        user2Workspace.getCloseButton().addGestureListener(TapAndHoldProcessor.class, new CloseButtonListener(AbstractMTWDSceneController.USER2_ID));
        ...
        user3Workspace.getCloseButton().addGestureListener(TapAndHoldProcessor.class, new CloseButtonListener(AbstractMTWDSceneController.USER3_ID));
        ...
        user4Workspace.getCloseButton().addGestureListener(TapAndHoldProcessor.class, new CloseButtonListener(AbstractMTWDSceneController.USER4_ID));
