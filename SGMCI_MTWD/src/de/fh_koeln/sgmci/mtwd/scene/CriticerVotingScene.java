...
public class CriticerVotingScene extends AbstractMTWDScene {
    ...
    public void startScene() {
        ...
        user1Workspace.fillVotedIdeas(((CriticerVotingSceneController) controller).getAllVotedIdeasForUser(AbstractMTWDSceneController.USER1_ID));
        user2Workspace.fillVotedIdeas(((CriticerVotingSceneController) controller).getAllVotedIdeasForUser(AbstractMTWDSceneController.USER2_ID));
        user3Workspace.fillVotedIdeas(((CriticerVotingSceneController) controller).getAllVotedIdeasForUser(AbstractMTWDSceneController.USER3_ID));
        user4Workspace.fillVotedIdeas(((CriticerVotingSceneController) controller).getAllVotedIdeasForUser(AbstractMTWDSceneController.USER4_ID));
    }
