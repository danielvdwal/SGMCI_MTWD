 ...
 * It implements the IUserContinueStrategy interface without implementing its methods,
 * due to different requirements regarding the number of users using the application.
 * 
...
public abstract class AbstractUserContinueStrategy implements IUserContinueStrategy {
    ...
    /** The controller to be checked for the requirements that have to be fulfilled to continue. */
